...
function sendRecoveryMail($recipient, $encryptedEmail) {
    ...
    $body = 'Hello, <br/> <br/>Click the link to reset the password for ' . $recipient . ' '
            ...
            . 'http://localhost/BachelorMVC/mvc/public/password/forgot?encrypt=' . $encryptedEmail . '&action=reset '
            . '<br/> <br/>--<br>';
...
function sendEmail_pickedProvider($information) {
    ...
    $body = 'Hello, <br/> <br/>You have been chosen to cater, information as follows' .
            '<br><br>';
