...
<html>
    ...
    <script>
        function getFoodList(value) {
            ...
            $.post("controllers/admin_controller.php", {partial_food: value})
                    .done(function (data) {
        ...
        function getCustomerList(value) {
            $.post("controllers/admin_controller.php", {partial_customer: value})
                    .done(function (data) {
        ...
        function getProviderList(value) {
            $.post("controllers/admin_controller.php", {partial_provider: value})
                    .done(function (data) {
